...
public class MyConstant {
        ...
        // Swagger Info
        public static final String SWAGGER_INFO_TITLE = "BoatYard Terrace";
        public static final String SWAGGER_INFO_DESCRIPTION = "Online Boat House Booking Portal";
        public static final String SWAGGER_INFO_VERSION = "1.0.0";
        public static final String SWAGGER_INFO_CONTACT_NAME = "AKASH G - LOKESH T - JAYANDRA MUGILAN R A";
        public static final String SWAGGER_INFO_CONTACT_EMAIL = "boatyard@gmail.com";
        public static final String SWAGGER_INFO_CONTACT_URL = "boatyard";
